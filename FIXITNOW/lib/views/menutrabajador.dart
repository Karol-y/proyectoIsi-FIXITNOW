...
class MenuButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: ElevatedButton(
        style: ElevatedButton.styleFrom(
          foregroundColor: const Color.fromARGB(217, 255, 255, 255),
          backgroundColor: const Color.fromARGB(255, 54, 147, 222),
          padding: const EdgeInsets.symmetric(vertical: 16.0),
          shape: RoundedRectangleBorder(
            borderRadius: BorderRadius.circular(10.0),
            side: const BorderSide(color: Color.fromARGB(255, 54, 147, 222)),
          ),
        ),
        onPressed: onPressed, // Ejecuta la acción del botón
        child: Text(
